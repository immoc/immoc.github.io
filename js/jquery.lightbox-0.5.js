...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'images/litebox_loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			'images/litebox_prev.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			'images/litebox_next.gif',			// (string) Path and the name of the next button image
			imageBtnClose:			'images/litebox_closelabel.gif',		// (string) Path and the name of the close btn
			imageBlank:				'images/lightbox_blank.gif',			// (string) Path and the name of a blank image (one pixel)
